...
import { ScrollView, StyleSheet, Text, TextInput, View, Button, FlatList } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      <TextInput placeholder='Title' style={{marginTop: 30, fontSize: 18, width: 200, borderColor: 'gray', borderWidth: 1}}
        ...
        value={title}/>  
      <TextInput placeholder='date' keyboardType="numeric" style={{ marginTop: 5, marginBottom: 5,  fontSize:18, width: 200, borderColor: 'gray', borderWidth: 1}}
        onChangeText={(credit) => setCredit(credit)}
        value={credit}/>      
      <Button onPress={saveItem} title="Save" /> 
      <Text style={{marginTop: 30, fontSize: 20}}>Examinations</Text>
      <FlatList 
        style={{marginLeft : "1%"}}
